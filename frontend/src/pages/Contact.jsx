    ...
    <>
      ...
      <div className="lg:px-24">
        ...
        <div className="flex  lg:flex-row flex-col items-center w-full  ">
          <div className="flex flex-col px-4 md:px-12 2xl:px-28 space-y-4 mb-4 lg:w-5/4  items-center justify-center">
      ...
      <div className="lg:px-24">
        <div className="grid lg:grid-cols-2 mt-6 px-4 md:px-12 2xl:px-28 space-y-4  items-center justify-center">
