      ...
      <div className=" px-4 sm:px-6 lg:px-24">
        <div className=" text-center max-w-7xl w-full mx-auto  gap-12 items-center">
          ...
          >
            ...
            <div className="grid grid-cols-3 max-w-7xl w-full mx-auto md:gap-4 gap-3">
              {stats.map((stat, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`group md:p-4 p-3  rounded-xl cursor-pointer bg-linear-to-br from-gray-50 to-white border border-gray-100 hover:border-[#065f46]/30 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 ${
                      isVisible
