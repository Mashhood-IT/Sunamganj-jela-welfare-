...
const Hero = () => {
  ...
  return (
    <section className={`relative  mt-24 lg:pt-0 pt-12 ${isMobileScreen ? "h-[84vh]" :"h-screen" }  bg-gray-100 lg:mt-16 flex flex-col lg:flex-row overflow-hidden py-8 lg:py-0`}>
