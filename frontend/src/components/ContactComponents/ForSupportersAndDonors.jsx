...
const ForSupportersAndDonors = () => (
  <div className="w-full  py-16 px-4">
    <div className="max-w-4xl mx-auto">
      <div className="bg-white rounded-lg p-8 md:p-12 border-l-4 border-(--main-orange-color)]shadow-sm">
        <div className="flex items-center mb-6">
          ...
          <h2 className="text-3xl font-bold text-gray-900">For Supporters and Donors</h2>
        </div>
