      ...
      <div className="max-w-[1250px] mx-auto px-6">
        <div className="rounded-2xl shadow-xl bg-white/90 backdrop-blur-md p-10 md:p-14 text-center animate-fade-in">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            ...
            <li className="flex flex-col items-center bg-gray-50 rounded-xl p-6 shadow hover:shadow-lg transition">
              <span className="mb-3">
                <ICONS.HandCoins className="w-8 h-8 text-orange-500" />
              </span>
              <span className="font-bold text-lg text-gray-900">Donate</span>
              <span className="text-gray-700 mt-2">
                to support education and welfare projects.
              </span>
            </li>
            <li className="flex flex-col items-center bg-gray-50 rounded-xl p-6 shadow hover:shadow-lg transition">
              <span className="mb-3">
                <ICONS.HeartHandshake className="w-8 h-8 text-green-600" />
              </span>
              <span className="font-bold text-lg text-gray-900">
                Collaborate
              </span>
              <span className="text-gray-700 mt-2">
                to extend our reach to new communities.
              </span>
            </li>
          </ul>
          ...
          <p className="text-center text-gray-700 mb-6 text-base md:text-lg">
            Our journey is far from over. We will keep learning, growing, and
            giving. We see a future where help travels faster than hardship. A
            future where Sunamganj and the UK Bangladeshi community stand linked
