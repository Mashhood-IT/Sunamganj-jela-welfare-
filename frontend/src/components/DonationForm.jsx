  ...
  const DonationForm = () => {
    ...
    return (
      <>
        <HeroSection
          title="Support Us"
          description="Contribute to our mission and help us provide essential services to those who need them most."
        />
          ...
          <div className="bg-white shadow-xl rounded-2xl p-8 w-full max-w-lg">
            ...
            {!showStripe ? (
              <form onSubmit={handleNext} className="space-y-5">
                ...
                <input
                  type="number"
                  placeholder={`${selectedCurrency.symbol} Custom Amount`}
                  value={customAmount}
                  onChange={(e) => {
